...
function SalonCard({ salon }) {
  ...
  return (
    <div
      className="bg-white rounded-[16px] border border-[#5C837433] overflow-hidden w-auto xl:max-w-[340px] flex flex-col cursor-pointer"
    ...
    >
      ...
      <div className="p-[16px] flex flex-col">
        <span className="text-[#0F3D3E] text-[18px] font-medium line-clamp-1 font-poppins">
          {salon.salonName || "Unnamed Salon"}
        </span>

        <div className="flex items-center gap-2 text-[#777] text-[15px] mt-3">
          <FiMapPin className="text-[#5C8374] text-[18px] flex-shrink-0" />

          <span className="lg:text-[12px] xl:text-[14px] font-normal line-clamp-1 font-inter text-[#5C8374] ">
            {salon.salonAddress ?
