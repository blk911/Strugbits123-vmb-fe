  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-md">
      <div className="flex justify-between items-center mb-4 sm:px-[20px]">
        <h2 className="text-lg font-semibold text-[#6d013a]">
          {" "}
          <span
        ...
        <SelectField
          ...
          classes="!w-[144px] !text-[#000000] !rounded-[8px]"
          icon={
            <svg
              width="13"
              height="8"
        ...
        >
          ...
          <defs>
            <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#FF92A5" stopOpacity={1} />
              <stop offset="100%" stopColor="#FF92A5" stopOpacity={1} />
            </linearGradient>
          </defs>
