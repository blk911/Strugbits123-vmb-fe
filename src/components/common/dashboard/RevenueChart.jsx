...
export default function RevenueChart() {
  ...
  return (
    <div className="bg-white/50 rounded-2xl p-6 border border-vmb-primary/10 shadow-sm">
      <div className="flex justify-between items-center mb-4 sm:px-[20px]">
        <h2 className="text-lg font-semibold text-vmb-primary">
          {" "}
          <span
            className="max-xl:text-[18px] text-vmb-primary xl:text-[21px] max-xl:leading-[20px]"
            style={{
        ...
        <SelectField
          option={["Last 7 days", "Last 6 days", "Last 5 days"]}
          classes="!w-[144px] !text-vmb-text-main !rounded-[8px]"
          icon={
            <svg
              width="13"
              height="8"
        ...
        >
          ...
          <Tooltip
            contentStyle={{
              ...
              border: "none",
              background: "white",
              boxShadow: "0px 2px 6px var(--vmb-primary-soft)",
            }}
          />

          <defs>
            <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="var(--vmb-secondary)" stopOpacity={1} />
              <stop offset="100%" stopColor="var(--vmb-secondary)" stopOpacity={1} />
            </linearGradient>
          </defs>
          ...
          <Line
            ...
            dot={(props) => {
              ...
              const prev = index > 0 ? data[index - 1].revenue : null;
              const isDown = prev !== null && payload.revenue < prev;
              ...
              return (
                <circle
                  ...
                  cy={cy}
                  r={6}
                  fill={isDown ? "var(--vmb-primary)" : "var(--vmb-secondary)"}
                  stroke="#fff"
                  strokeWidth={0}
                />
              );
