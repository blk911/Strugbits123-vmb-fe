    ...
    <div className="bg-white rounded-[15px] p-4 sm:p-6 shadow-sm border border-vmb-primary/5">
      <div className="hidden lg:grid lg:grid-cols-12 gap-4 px-6 py-3 mb-6 bg-vmb-table-header rounded-[10px]">
        ...
        <div className="col-span-2 text-right">
          <div className="flex items-center justify-end gap-2 text-vmb-secondary font-semibold text-[14px] lg:text-[16px]">
      ...
      <div className="flex flex-col gap-4">
        ...
        : customers.map((user) => (
            ...
            >
              <div className="col-span-3 w-full flex items-center gap-4 font-poppins font-medium text-vmb-text-muted">
                <img
                  src={user.userProfile || userPlaceholder}
                  alt={user.name}
                  className="w-10 h-10  rounded-full object-cover border border-vmb-primary/10 flex-shrink-0"
                />
                <span className="font-medium text-vmb-text-muted text-[14px] ">
                  {user.name || "Unknown"}
                </span>
              </div>
              ...
              <div className="col-span-1 w-full text-left">
                ...
                <span className=" text-[14px] ">{user.zipcode || "N/A"}</span>
              </div>
