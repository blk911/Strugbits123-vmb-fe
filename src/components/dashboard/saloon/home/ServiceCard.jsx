export default function ServiceCard({ img, title, desc, price }) {
  return (
    <div className="border border-[#0000001A] p-4 rounded-[10px] flex flex-col sm:flex-row  gap-4 items-start bg-[#FF92A51A] hover:bg-white transition cursor-pointer">
