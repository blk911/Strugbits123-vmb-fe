    ...
    <Modal isOpen={isOpen} closeModal={closeModal}>
      <DialogPanel className="w-full flex flex-col gap-y-[20px] sm:gap-y-[32px] lg:w-max transform overflow-hidden rounded-2xl bg-white p-6  text-left align-middle shadow-xl transition-all">
        ...
        <SelectField
          ...
          classes={"!text-[#00000033] !appearance-none text-[#00000080]"}
        />
        ...
        <div className="w-full grid grid-col-2 sm:grid-cols-3 gap-y-[10px] items-center gap-x-[36px]">
          <TextField
            ...
            name="price"
            placeholder="Price"
            classInput="placeholder:text-[#00000080] !text-sm"
          />
          <SelectField
            label="Service Duration"
            option={["01 Hr - 02Hr"]}
            classes="h-[48px] text-[#00000080]"
          />
          <SelectField
        ...
        <Button text="Add Service" classes={"w-[160px] self-end"} />
      </DialogPanel>
    </Modal>
  );
}
