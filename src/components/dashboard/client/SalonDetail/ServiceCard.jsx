...
// export default function ServiceCard({ name, duration, price, description, image }) {
//   return (
...
//         <h4 className="text-[#581838] font-medium text-[18px] leading-[24px]">{name}</h4>
//         <span className="text-[#6B7280] font-bold text-[18px]">${price}</span>
//       </div>

//       <p className="text-[#4B5563] text-[14px] leading-[18px]">{description}</p>

//       <div className="flex gap-3 flex-col lg:flex-row">
//         <button className="flex-1 bg-[#FF92A54D] text-[#FF92A5] rounded-[8px] py-2 px-3 flex items-center justify-center gap-2">
//           <FaGift className="text-[#FF92A5]" />
//           <span className="text-[16px] font-medium">Request Service</span>
//         </button>

//         <button className="flex-1 border border-[#FF92A5] text-[#FF92A5] rounded-[8px] py-2 px-3 flex items-center justify-center gap-2">
//           <FaRegCalendarAlt />
//           <span className="text-[16px] font-medium">Book Now</span>
//         </button>
//       </div>
//     </div>
//   );
