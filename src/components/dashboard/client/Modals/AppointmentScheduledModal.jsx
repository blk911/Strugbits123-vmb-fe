            ...
            <Dialog.Panel className="relative w-full max-w-[460px] transform overflow-hidden rounded-[20px] border border-[#5818381A] bg-[#FFF2F4] p-[30px] shadow-xl transition-all flex flex-col gap-[23px]">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[#00000080] text-[14px] mt-2 leading-[20px]">
                  The salon has successfully scheduled your appointment. Please
              ...
              <div className="bg-white border border-[#0000001A] rounded-[10px] p-5 flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-3 justify-between">
                  <button className="flex-1 border border-[#581838] text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all">
                    Hold
                  </button>
                  <button className="flex-1 border border-[#581838] text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all">
                    Reschedule
                  ...
                  <button className="flex-1 border border-[#581838] bg-white text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all">
                    Decline
                  </button>
                  <button className="flex-1 border border-[#FF92A5] bg-[#FF92A5] text-white rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:opacity-90 transition-all">
                    Accept
                  </button>
                </div>
              </div>
