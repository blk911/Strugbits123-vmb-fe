...
// export default function AppointmentScheduledModal({ isOpen, closeModal }) {
//   const [mock] = useState({
//     salon: {
...
//   const totalPrice = mock.services.reduce((sum, s) => sum + s.price, 0);
...
//                     <button className=" cursor-pointer border border-[#581838] text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all w-full">
//                       Hold
//                     </button>
//                     <button className="cursor-pointer border border-[#581838] text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all w-full">
//                       Reschedule
...
//                     <button className="cursor-pointer border border-[#581838] bg-white text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all w-full">
//                       Decline
//                     </button>
//                     <button className="cursor-pointer border border-[#FF92A5] bg-[#FF92A5] text-white rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:opacity-90 transition-all w-full">
//                       Accept
//                     </button>
//                   </div>
//                 </div>
...
//   );
// }
// AppointmentScheduledWithFlows.jsx
import { Dialog, Transition } from "@headlessui/react";
import { Fragment, useState } from "react";
import { IoClose, IoTimeOutline, IoCalendarOutline } from "react-icons/io5";
import salonIcon from "../../../../assets/salon-1.png";
                  ...
                  <div className="bg-white border border-[#0000001A] rounded-[10px] p-5 flex flex-col gap-4">
                    ...
                    <div className=" flex-1">
                      <button
                        ...
                        className="w-full border border-[#E5E7EB] bg-[#FF92A5] text-white font-semibold text-[14px] rounded-[8px] px-[20px] py-[12px]"
                      >
                ...
                <Dialog.Panel className="relative w-full max-w-[460px] transform overflow-hidden rounded-[20px] border border-[#5818381A] bg-[#FFF2F4] p-[30px] shadow-xl transition-all flex flex-col gap-[23px]">
                  ...
                  <div className="bg-white border border-[#0000001A] rounded-[10px] p-5 flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full sm:grid-cols-2">
                      <button
                        onClick={openHold}
                        className="cursor-pointer border border-[#581838] text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all w-full"
                      >
                        Hold
                      </button>
                      <button
                      ...
                      <button
                        onClick={openDecline}
                        className="cursor-pointer border border-[#581838] bg-white text-[#581838] rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:bg-[#581838]/10 transition-all w-full"
                      >
                        Decline
                      </button>
                      <button
                        onClick={openConfirm}
                        className="cursor-pointer border border-[#FF92A5] bg-[#FF92A5] text-white rounded-[8px] py-[15px] px-[20px] text-[14px] font-medium hover:opacity-90 transition-all w-full"
                      >
                        Accept
                      </button>
                    </div>
