...
export default function SalonCard({ salon }) {
  ...
  return (
    <div
      className="border border-[#58183880] rounded-[12px] p-3 sm:p-4 
    ...
    >
      ...
      <div className="flex flex-col flex-1 mt-3 gap-3">
        <div className="hidden sm:flex justify-between items-start ">
          <h3
            className="text-[#581838] font-medium text-[18px] leading-[24px] 
                         line-clamp-2 max-w-[60%]"
          >
            {salon?.salonName}
          </h3>
          <span
            className="text-[#00000080] text-[12px] font-medium 
        ...
        <p
          className="text-[#4B5563] text-[12px] font-medium leading-[14px] 
                      line-clamp-2 "
        >
          {salon?.description || " "}
        </p>
