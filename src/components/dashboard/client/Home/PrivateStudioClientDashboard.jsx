    ...
    <div className="min-h-[calc(100vh-8rem)] bg-[#f5eee9] font-poppins text-[#333232]">
      <div className="mx-auto flex max-w-[1240px] flex-col gap-8 px-4 py-6 sm:px-6 lg:px-8">
        <section className="overflow-hidden rounded-[8px] bg-white shadow-[0_18px_56px_-38px_rgba(39,46,45,0.7)]">
          <div className="grid gap-0 lg:grid-cols-[1fr_420px]">
            <div className="px-6 py-8 sm:px-8 lg:px-10 lg:py-12">
              <p className="text-[11px] font-bold uppercase tracking-[0.26em] text-[#a45f76]">
                VMB Client Circle
              </p>
              ...
              <p className="mt-5 max-w-2xl text-base leading-7 text-[#6b6262]">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[4px] bg-[#333232] px-5 text-sm font-bold text-white transition hover:bg-[#4c4a4a]"
                >
                ...
                <button
                  ...
                  className="inline-flex min-h-11 items-center justify-center gap-2 rounded-[4px] border border-[#333232]/20 px-5 text-sm font-bold text-[#333232] transition hover:bg-[#f5eee9]"
                >
                  <FaGift aria-hidden />
                  Request A Gift
                </button>
            ...
            <div className="bg-[#333232] p-5 text-white lg:p-7">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="rounded-[8px] border border-[#e2d8c8] bg-white p-6 sm:p-7">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div
                  key={title}
                  className="rounded-[8px] bg-[#fffdfb] p-4 ring-1 ring-[#e2d6cf]"
                >
                  <span className="flex h-7 w-7 items-center justify-center rounded-full bg-[#333232] text-xs font-bold text-white">
                    {index + 1}
                  </span>
          ...
          <div className="rounded-[8px] bg-[#eadfd8] p-6 sm:p-7">
            <FaRegStar className="text-2xl text-[#a45f76]" aria-hidden />
            <h2 className="mt-4 font-studio-serif text-3xl">
              Best people to invite
            </h2>
            <p className="mt-3 text-sm leading-6 text-[#6b6262]">
            ...
            <button
              ...
              className="mt-5 inline-flex min-h-10 items-center justify-center gap-2 rounded-[4px] bg-[#333232] px-4 text-sm font-bold text-white transition hover:bg-[#4c4a4a]"
            >
              <FaUsers aria-hidden />
              Find A Salon
            </button>
            ...
            {quickActions.map((item) => {
              ...
              return (
                <button
                  ...
                  className="rounded-[8px] border border-[#e2d6cf] bg-[#fffdfb] p-5 text-left transition hover:border-[#333232]/30 hover:bg-[#f5eee9]"
                >
        ...
        <section className="rounded-[8px] border border-[#ded3cc] bg-[#333232] p-6 text-white sm:p-7">
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            ...
            <button
              ...
              className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-[4px] bg-white px-5 text-sm font-bold text-[#333232] transition hover:bg-[#c0a05a]"
            >
