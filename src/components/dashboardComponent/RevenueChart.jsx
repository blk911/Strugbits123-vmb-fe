    ...
    <div className="bg-white rounded-2xl p-6 shadow-md">
      ...
      <ResponsiveContainer width="100%" height={280}>
        <LineChart data={data} margin={{
          top: 5,
          right: 30,
           left: isMobile ? 0 : 20,  // 👈 mobile responsive margin
          bottom: 5,
        }}>
          {/* Axes */}
            ...
            dot={(props) => {
              ...
              return (
                <circle
                  ...
                  cy={cy}
                  r={6}
                  fill={isDown ? "#581838" : "#FF92A5"} // dark purple if down, pink otherwise
                  stroke="#fff"
                  strokeWidth={0}
                />
              );
            }}
            activeDot={{ r: 8, fill: "#FF92A5", stroke: "#6d013a", strokeWidth: 2 }}
          />
