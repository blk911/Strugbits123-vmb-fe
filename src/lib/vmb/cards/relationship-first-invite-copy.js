...
export const RELATIONSHIP_FIRST_INVITE_CARDS = [
    {
        ...
        relationshipBenefitTemplate: "It's the easiest way to stay connected with me, get first access to your favorite appointment times, receive special client-only offers, surprise gifts, and invitations to events before they're announced publicly.\n\nIt's also where I share referral rewards and little thank-you surprises for the people who support my business.\n\nI'd love to have you there.",
    ...
    },
    {
        ...
        label: "We Miss You",
        greetingTemplate: "Dear {clientName},",
        messageTemplate: "It's been a while since our last visit and I wanted to check in.\n\nLife gets busy, schedules get packed, and before you know it months have passed.",
        relationshipBenefitTemplate: "I miss seeing you and would love the chance to catch up. I have a few openings available if you're ready for some time for yourself.",
        signatureTemplate: SIGNATURE,
    ...
    },
    {
        ...
        greetingTemplate: "Dear {clientName},",
        messageTemplate: "A cancellation just opened a spot on my calendar and I immediately thought of you.\n\nBefore I release it publicly, I wanted to offer it to a few favorite clients first.",
        relationshipBenefitTemplate: "If you'd like it, I can reserve it for your usual {serviceName} appointment.",
        signatureTemplate: SIGNATURE,
    ...
    },
    {
        ...
        label: "VIP Thank You",
        greetingTemplate: "Dear {clientName},",
        messageTemplate: "I wanted to personally thank you.\n\nYour trust, loyalty, referrals, and support have helped me build the business I dreamed about.\n\nEvery appointment, every recommendation, and every friend you've sent my way has mattered.",
        relationshipBenefitTemplate: "I put together a little VIP surprise just for you because clients like you are the foundation of my success.",
        signatureTemplate: SIGNATURE,
    ...
    },
    {
        ...
        label: "Birthday",
        greetingTemplate: "Dear {clientName},",
        messageTemplate: "Happy Birthday!\n\nI hope your day is filled with people you love, great memories, and a little time to spoil yourself.",
        relationshipBenefitTemplate: "I wanted to celebrate with you and send a small birthday surprise your way.",
        signatureTemplate: SIGNATURE,
    ...
    },
    {
        ...
        greetingTemplate: "Dear {clientName},",
        messageTemplate: "Thank you for booking with me.\n\nI know there are a lot of choices, and I'm honored you've trusted me with your upcoming appointment.",
        relationshipBenefitTemplate: "My goal is simple: I want you to leave feeling beautiful, confident, and excited to come back.\n\nI can't wait to meet you.",
        signatureTemplate: SIGNATURE,
    ...
    },
    {
        ...
        greetingTemplate: "Dear {clientName},",
        messageTemplate: "Thank you for spending part of your day with me.\n\nI loved meeting you and having the opportunity to work with you.",
        relationshipBenefitTemplate: "I'd love to stay connected, share future openings, special offers, and a few surprises along the way.",
        signatureTemplate: SIGNATURE,
    ...
    },
    {
        ...
        greetingTemplate: "Dear {clientName},",
        messageTemplate: "One of my favorite things about this business is connecting great people with great professionals.",
        relationshipBenefitTemplate: "Whether it's nails, hair, lashes, skin care, massage, or something else, I'd love to know who your favorite providers are.\n\nI'm always looking for amazing people to introduce my clients to.",
        signatureTemplate: SIGNATURE,
...
const TEMPLATE_TYPE_TO_CARD_ID = {
...
const OUTREACH_CATEGORY_TO_CARD_ID = {
...
export function firstNameFromRecipient(name) {
    const trimmed = name?.trim();
    if (!trimmed)
        return "friend";
    return trimmed.split(/\s+/)[0] || trimmed;
}
function applyRelationshipFirstTokens(text, vars) {
...
export function assembleRelationshipFirstInviteMessage(card, vars = {}) {
...
export function getRelationshipFirstCard(id) {
...
export function listRelationshipFirstInviteCards() {
    return RELATIONSHIP_FIRST_INVITE_CARDS.map((card) => ({ ...card }));
}
export function getRelationshipFirstCardForTemplateType(type) {
    return getRelationshipFirstCard(TEMPLATE_TYPE_TO_CARD_ID[type]);
}
export function getRelationshipFirstCardForOutreachCategory(category) {
...
export function buildRelationshipFirstOutreachMessage(card, vars) {
...
export function buildRelationshipFirstOutreachSubject(card, vars) {
