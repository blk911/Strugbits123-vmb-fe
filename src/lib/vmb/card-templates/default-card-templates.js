...
import { VMB_CARD_TEMPLATE_TOKENS } from "./card-template-types.js";
const BASE_TOKENS = [...VMB_CARD_TEMPLATE_TOKENS];
const NOW = "2026-06-12T00:00:00.000Z";
function seedTemplate(type) {
...
export const DEFAULT_CARD_TEMPLATES = VMB_CARD_TYPES.map((type) => seedTemplate(type));
