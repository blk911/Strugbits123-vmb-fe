/**
 * Deep Insights — normalized salon model and provider export registry (front-end only).
...
/**
 * VMB normalized entities used across Deep Insights mapping and preflight.
...
/**
 * Deep Insights demo CSV registry (served from `public/sample-exports/deep-dig/`).
